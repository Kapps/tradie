...
goog.exportSymbol('proto.ModifierCriteria', null, global);
/**
 ...
 * @constructor
 */
proto.ModifierCriteria = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.ModifierCriteria, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.ModifierCriteria.displayName = 'proto.ModifierCriteria';
}
...
proto.Criteria.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    modifier: (f = msg.getModifier()) && proto.ModifierCriteria.toObject(includeInstance, f),
...
proto.Criteria.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      break;
    case 10:
      var value = new proto.ModifierCriteria;
      reader.readMessage(value,proto.ModifierCriteria.deserializeBinaryFromReader);
...
proto.Criteria.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      10,
      f,
      proto.ModifierCriteria.serializeBinaryToWriter
    );
  }
...
/**
 * optional ModifierCriteria modifier = 10;
 * @return {?proto.ModifierCriteria}
 */
proto.Criteria.prototype.getModifier = function() {
  return /** @type{?proto.ModifierCriteria} */ (
    jspb.Message.getWrapperField(this, proto.ModifierCriteria, 10));
};


/**
 * @param {?proto.ModifierCriteria|undefined} value
 * @return {!proto.Criteria} returns this
*/
 ...
 * @return {!Object}
 */
proto.ModifierCriteria.prototype.toObject = function(opt_includeInstance) {
  return proto.ModifierCriteria.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.ModifierCriteria} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ModifierCriteria.toObject = function(includeInstance, msg) {
  var f, obj = {
    modifierhash: jspb.Message.getFieldWithDefault(msg, 1, "0"),
 ...
 * @return {!proto.ModifierCriteria}
 */
proto.ModifierCriteria.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.ModifierCriteria;
  return proto.ModifierCriteria.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.ModifierCriteria} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.ModifierCriteria}
 */
proto.ModifierCriteria.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.ModifierCriteria.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.ModifierCriteria.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.ModifierCriteria} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.ModifierCriteria.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getModifierhash();
  if (parseInt(f, 10) !== 0) {
...
/**
 * optional int64 modifierHash = 1;
 * @return {string}
 */
proto.ModifierCriteria.prototype.getModifierhash = function() {
...
/**
 * @param {string} value
 * @return {!proto.ModifierCriteria} returns this
 */
proto.ModifierCriteria.prototype.setModifierhash = function(value) {
 ...
 * @return {number}
 */
proto.ModifierCriteria.prototype.getKind = function() {
 ...
 * @return {!proto.ModifierCriteria} returns this
 */
proto.ModifierCriteria.prototype.setKind = function(value) {
