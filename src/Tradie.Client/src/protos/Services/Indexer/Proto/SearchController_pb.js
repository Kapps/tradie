...
proto.SearchRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    query: (f = msg.getQuery()) && proto.SearchQuery.toObject(includeInstance, f)
  };
...
proto.SearchRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.SearchQuery;
      reader.readMessage(value,proto.SearchQuery.deserializeBinaryFromReader);
      msg.setQuery(value);
      break;
    default:
      reader.skipField();
...
proto.SearchRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f != null) {
    writer.writeMessage(
      1,
      f,
      proto.SearchQuery.serializeBinaryToWriter
    );
  }
};
...
proto.SearchRequest.prototype.getQuery = function() {
  return /** @type{?proto.SearchQuery} */ (
    jspb.Message.getWrapperField(this, proto.SearchQuery, 1));
};
 ...
 * @return {!Array<string>}
 */
proto.SearchResponse.prototype.getIdsList = function() {
 ...
 */
proto.SearchResponse.prototype.setIdsList = function(value) {
 ...
 * @return {!proto.SearchResponse} returns this
 */
proto.SearchResponse.prototype.addIds = function(value, opt_index) {
 ...
 * @return {!proto.SearchResponse} returns this
 */
proto.SearchResponse.prototype.clearIdsList = function() {
...
proto.SearchGroup.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.AffixRange.toObject, includeInstance)
  };
...
proto.SearchGroup.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = new proto.AffixRange;
      reader.readMessage(value,proto.AffixRange.deserializeBinaryFromReader);
      msg.addRanges(value);
      break;
    default:
      reader.skipField();
...
proto.SearchGroup.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      2,
      f,
      proto.AffixRange.serializeBinaryToWriter
    );
  }
};
...
proto.SearchGroup.prototype.getRangesList = function() {
  return /** @type{!Array<!proto.AffixRange>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.AffixRange, 2));
};
...
proto.SearchGroup.prototype.addRanges = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.AffixRange, opt_index);
};
 ...
 * @return {?proto.ModKey}
 */
proto.AffixRange.prototype.getKey = function() {
  return /** @type{?proto.ModKey} */ (
...
*/
proto.AffixRange.prototype.setKey = function(value) {
  return jspb.Message.setWrapperField(this, 1, value);
};
 ...
 * @return {!proto.AffixRange} returns this
 */
proto.AffixRange.prototype.clearKey = function() {
 ...
 * @return {boolean}
 */
proto.AffixRange.prototype.hasKey = function() {
  return jspb.Message.getField(this, 1) != null;
};
