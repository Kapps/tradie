...
namespace Tradie.Analyzer.Migrations
{
    ...
    [Migration("20220227212033_LoggedItemsWithinTabDocument")]
    partial class LoggedItemsWithinTabDocument
    {
            ...
            modelBuilder.Entity("Tradie.Analyzer.Entities.LoggedStashTab", b =>
                {
                    ...
                    b.HasIndex(new[] { "Items" }, "idx_tab_Items");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex(new[] { "Items" }, "idx_tab_Items"), "GIN");
